...
function FilterAction({ posts, categories, popularTags, filters }: Props) {
                        ...
                        <Card className="p-4 border-0">
                            ...
                            <form onSubmit={handleSearch} className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        <label className="text-sm text-gray-600 mb-1 block flex items-center gap-x-2">
                                ...
                                <Button type="submit" className="w-full flex items-center gap-x-2">
                    ...
                    <div className="lg:col-span-3">
                        {posts.data.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <h3 className="mt-2 text-sm font-medium text-gray-900">{t('no_posts_found')}</h3>
...
export default function Index({ posts, categories, popularTags, filters }: Props) {
    return (
        <FrontAppLayout title="Blog">
            <FilterAction posts={posts} categories={categories} popularTags={popularTags} filters={filters} />
        </FrontAppLayout>
    );
}
